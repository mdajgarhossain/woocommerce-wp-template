...
class Ecommerce_Landing_Page_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'ecommerce-landing-page' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $ecommerce_landing_page_font_awesome_icon_array = ecommerce_landing_page_font_awesome_icon_array();
                    foreach ($ecommerce_landing_page_font_awesome_icon_array as $ecommerce_landing_page_font_awesome_icon) {
                            $icon_class = $this->value() == $ecommerce_landing_page_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($ecommerce_landing_page_font_awesome_icon).'"></i>
                            <span class="ecommerce-landing-page-social-class">'.esc_attr($ecommerce_landing_page_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function ecommerce_landing_page_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'ecommerce-landing-page-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'ecommerce_landing_page_customizer_script' );

if(!function_exists('ecommerce_landing_page_font_awesome_icon_array')){
    function ecommerce_landing_page_font_awesome_icon_array(){
